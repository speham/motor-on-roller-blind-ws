...
<!-- --------------------1 -->
   ...
   <ons-card>
    ...
    <ons-row>
      ...
      <ons-col width='150px' style='text-align: right; line-height: 50px;'>switch 1
        <ons-switch disabled style='vertical-align: middle;' id='button-sw1' ></ons-switch>
      </ons-col>
      <ons-col width='150px' style='text-align: center; line-height: 50px;'>switch 2
